...
# Demonstration
I wrote a small test case for visualizing the initialization step. The green circles in the bottom image below are the key points which are matched with the previous frame. The pose estimated from the essential matrix of these points is visualized by the two blue triangles. The green points have been triangulated into 3d, and you'll notice the arrangement is very similar to what you see in the image.

![[Pasted image 20250109191822.png]]
